                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Column(
                      ...
                      children: [
                        ...
                        Image.asset(flowerlist[index].image,height: 180,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                        ...
                        Expanded(
                          child: GridView.count(
                            ...
                            primary: false,
                            children: [
                              for(int i = 0;i<flowerquestion [index].answer.length;i++)
                                MaterialButton(
                                  shape: BeveledRectangleBorder(borderRadius: BorderRadius.circular(20.0),),
                                  elevation: 10.0,
                                  height: 10,
                                  minWidth: double.infinity,
                                  color: isPressed ? flowerquestion[index].answer.entries.toList()[i].value?istrue:isWrong:Colors.white,
                                  padding: EdgeInsets.symmetric(vertical:18.0),
                                  onPressed: isPressed?(){}
                                      :(){
                                    if(flowerquestion[index].answer.entries.toList()[i].value){
                                      setState(() {
                                        isPressed = true;
                                      }
                                      );
                                  ...
                                  child: Text(
                                    flowerquestion[index].answer.keys.toList()[i],
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontFamily: "arlrdbd",
                                        fontSize: 20.0
                          ...
                          children: [
                            Align(
                              ...
                              child: OutlinedButton(
                                ...
                                onPressed: isPressed ? index + 1== flowerquestion.length
                                    ?(){
                                ...
                                child: Text(
                                  index + 1 == flowerquestion.length? "See Result":"Next Question",
                                  style: TextStyle(
                                    fontSize: 20.0,
                                    color: Colors.black,
                                    fontFamily: "arlrdbd",
