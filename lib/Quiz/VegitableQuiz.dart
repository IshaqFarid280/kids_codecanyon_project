                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Column(
                      ...
                      children: [
                        ...
                        Image.asset(vegitablelist[index].image,height: 180,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                        ...
                        Expanded(
                          child: GridView.count(
                            ...
                            primary: false,
                            children: [
                              for(int i = 0;i<vegitablequestion [index].answer.length;i++)
                                MaterialButton(
                                  shape: BeveledRectangleBorder(borderRadius: BorderRadius.circular(20.0),),
                                  elevation: 10.0,
                                  height: 10,
                                  minWidth: double.infinity,
                                  color: isPressed ? vegitablequestion[index].answer.entries.toList()[i].value?istrue:isWrong:Colors.white,
                                  padding: EdgeInsets.symmetric(vertical:18.0),
                                  onPressed: isPressed?(){}
                                      :(){
                                    if(vegitablequestion[index].answer.entries.toList()[i].value){
                                      setState(() {
                                        isPressed = true;
                                      }
                                      );
                                  ...
                                  child: Text(
                                    vegitablequestion[index].answer.keys.toList()[i],
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontFamily: "arlrdbd",
                                        fontSize: 20.0
                          ...
                          children: [
                            Align(
                              ...
                              child: OutlinedButton(
                                ...
                                child: Text(
                                  index + 1 == vegitablequestion.length? "See Result":"Next Question",
                                  style: TextStyle(
                                    fontSize: 20.0,
                                    color: Colors.black,
                                    fontFamily: "arlrdbd",
