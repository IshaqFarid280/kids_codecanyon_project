                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(flowerlist[index].Text,style: TextStyle(color: Colors.black,fontSize: 23.0,fontFamily: "arlrdbd"),),
                        ),
                        Column(
                            ...
                            children: [
                              for(int i = 0;i<alphasongs2 [index].answer.length;i++)
                                MaterialButton(
                                  ...
                                  color: isPressed ? flowerssongs2  [index].answer.entries.toList()[i].value?istrue:isWrong:Colors.white,
                                  padding: EdgeInsets.symmetric(vertical:10.0),
                                  onPressed: isPressed?(){}
                                      :(){
                                    if(flowerssongs2[index].answer.entries.toList()[i].value){
                                      setState(() {
                                        isPressed = true;
                                      }
                                      );
                                  ...
                                  child: Image(
                                    image: AssetImage(flowerssongs2[index].answer.keys.toList()[i]),height: 100,
                                  ),
                                ),
                            ],
                          ),
                        ...
                        Column(
                            ...
                            children: [
                              InkWell(
                                  onTap: ()=>flutterTts.speak(flowerlist[index].Text),
                                  child: Image.asset('assets/images/11MaskGroup3.png',alignment: Alignment.topCenter,)),
                              Center(
                                  child: ListTile(
                                    trailing: InkWell(
                                      onTap:  isPressed ? index + 1== flowerquestion.length
                                          ?(){
                                        ...
                                        flutterTts.speak(flowerlist[index  +1].Text);
