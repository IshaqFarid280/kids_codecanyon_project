                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(FRUITlist[index].Text,style: TextStyle(color: Colors.black,fontSize: 23.0,fontFamily: "arlrdbd"),),
                        ),
                        Column(
                            ...
                            children: [
                              for(int i = 0;i<alphasongs2 [index].answer.length;i++)
                                MaterialButton(
                                  ...
                                  color: isPressed ? fruitsongs2  [index].answer.entries.toList()[i].value?istrue:isWrong:Colors.white,
                                  padding: EdgeInsets.symmetric(vertical:10.0),
                                  onPressed: isPressed?(){}
                                      :(){
                                    if(fruitsongs2[index].answer.entries.toList()[i].value){
                                      setState(() {
                                        isPressed = true;
                                      }
                                      );
                                  ...
                                  child: Image(
                                    image: AssetImage(fruitsongs2[index].answer.keys.toList()[i]),height: 100,
                                  ),
                                ),
                            ],
                          ),
                        ...
                        Column(
                            ...
                            children: [
                              InkWell(
                                  onTap: ()=>flutterTts.speak(FRUITlist[index].Text),
                                  child: Image.asset('assets/images/11MaskGroup3.png')),
                              Center(
                                  child: ListTile(
                                    trailing: InkWell(
                                      onTap:  isPressed ? index + 1== fruitquestion.length
                                          ?(){
                                        ...
                                        flutterTts.speak(FRUITlist[index  +1].Text);
