                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(colorlist[index].Text,style: TextStyle(color: Colors.black,fontSize: 23.0,fontFamily: "arlrdbd"),),
                        ),
                        Column(
                            ...
                            children: [
                              for(int i = 0;i<animalsongs2 [index].answer.length;i++)
                                MaterialButton(
                                  ...
                                  child: Image(
                                    image: AssetImage(colorsongs2[index].answer.keys.toList()[i]),height: 100,
                                  ),
                                ),
                            ],
                          ),
                        ...
                        Column(
                            ...
                            children: [
                              InkWell(
                                  onTap: ()=>flutterTts.speak(colorlist[index].Text),
                                  ...
                                  child: ListTile(
                                    trailing: InkWell(
                                      onTap:  isPressed ? index + 1== animalquestion.length
                                        ...
                                        flutterTts.speak(colorlist[index  +1].Text);
                                      }:null,
                                      child: Image(
